...
export type VERIFY_EMAIL_FAILURE_EVENT = { type: "VERIFY_EMAIL_FAILURE"; error: string };

export type VERIFY_EMAIL_EXPIRED_EVENT = { type: "VERIFY_EMAIL_EXPIRED"; email: string };

export type VerifyEmailEvents = VERIFY_EMAIL_EVENT | VERIFY_EMAIL_SUCCESS_EVENT | VERIFY_EMAIL_FAILURE_EVENT | VERIFY_EMAIL_EXPIRED_EVENT;
