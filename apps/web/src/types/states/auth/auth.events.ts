...
export type SIGN_IN_SUCCESS_EVENT = { type: "SIGN_IN_SUCCESS"; accessToken: string; profile: UserProfile };
...
export type VERIFY_EMAIL_COMPLETED_EVENT = { type: "VERIFY_EMAIL_COMPLETED"; accessToken: string; profile: UserProfile };

export type VERIFY_EMAIL_SUCCESS_EVENT = { type: "VERIFY_EMAIL_SUCCESS"; accessToken: string; profile: UserProfile };
...
export type DONE_ACTOR_CHECK_AUTH_EVENT = DoneActorEvent<{ accessToken: string, profile: UserProfile }, "check-auth">;
