...
export type VerifyEmailEvents = VERIFY_EMAIL_EVENT | VERIFY_EMAIL_COMPLETED_EVENT | VERIFY_EMAIL_SUCCESS_EVENT | VERIFY_EMAIL_FAILED_EVENT | VERIFY_EMAIL_EXPIRED_EVENT | VERIFY_EMAIL_FINISHED_EVENT;
