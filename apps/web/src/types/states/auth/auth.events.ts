...
export type REGISTRATION_VERIFICATION_EVENT = { type: "REGISTRATION_VERIFICATION"; };

export type REGISTRATION_VERIFICATION_SUCCESS_EVENT = { type: "REGISTRATION_VERIFICATION_SUCCESS"; accessToken: string; profile: ProfileData };

export type REGISTRATION_VERIFICATION_FAILURE_EVENT = { type: "REGISTRATION_VERIFICATION_FAILURE"; error: string };

export type REGISTRATION_VERIFICATION_EXPIRED_EVENT = { type: "REGISTRATION_VERIFICATION_EXPIRED"; email: string };

export type RegistrationVerificationEvents = REGISTRATION_VERIFICATION_EVENT | REGISTRATION_VERIFICATION_SUCCESS_EVENT | REGISTRATION_VERIFICATION_FAILURE_EVENT | REGISTRATION_VERIFICATION_EXPIRED_EVENT;
